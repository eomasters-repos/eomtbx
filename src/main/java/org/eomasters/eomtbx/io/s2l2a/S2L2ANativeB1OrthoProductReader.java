...
//            } else {
    ...
    private void addAnglesBands(CoordinateReferenceSystem mapCRS, Dimension defaultProductSize, Product product,
                                EomS2OrthoSceneLayout sceneDescription, HashMap<String, S2BandAnglesGrid[]> bandAnglesGridsMap,
    ...
    private void addRasterMasks(List<S2Metadata.Tile> tileList, Product product, CoordinateReferenceSystem mapCRS,
                                List<BandInfo> bandInfoList, EomS2OrthoSceneLayout sceneDescription, S2SpatialResolution productResolution,
    ...
    private void addTileIndexes(Product product, CoordinateReferenceSystem mapCRS,
                                List<S2SpatialResolution> resolutions, List<S2Metadata.Tile> tileList, EomS2OrthoSceneLayout sceneDescription,
