 ...
 * @author Julien Malik
 */
public class EomS2OrthoSceneLayout extends S2SceneDescription {
    ...
    public static EomS2OrthoSceneLayout create(S2Metadata metadata) throws IOException {
        ...
        return new EomS2OrthoSceneLayout(tileInfos, sceneDimensions, sceneOrigin);
    }

    private EomS2OrthoSceneLayout(Map<String, TileInfo> tileInfos, Map<S2SpatialResolution, Dimension> sceneDimensions, double[] sceneOrigin) {
        super();
