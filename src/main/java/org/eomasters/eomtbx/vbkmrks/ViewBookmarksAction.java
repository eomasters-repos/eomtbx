...
@ActionRegistration(displayName = "#ViewBookmarksActionName", menuText = "#ViewBookmarksActionMenuText", lazy = false)
@ActionReference(path = "Menu/File", position = 10)
@NbBundle.Messages({"ViewBookmarksActionName=View Bookmarks", "ViewBookmarksActionMenuText=View Bookmarks",
    "OpenSettingsMenuText=Open Settings", "CreateBookmarkMenuText=Create Bookmark"})
