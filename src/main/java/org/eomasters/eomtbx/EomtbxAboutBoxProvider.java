...
/**
 * Provides the AboutBox for the EOMasters Toolbox.
 */
public class EomtbxAboutBoxProvider implements AboutBoxProvider {
  ...
  public ImageIcon getLogoImage() {
    return EomtbxIcons.EOMTBX.getImageIcon(365);
  }
  ...
  private static JLabel getCopyrightLabel() {
    ...
    JLabel copyrightLabel = new JLabel("<html><b>©2023-2026 Marco Peters from " + eomLink + "</b>",
  ...
  private static JLabel getVersionLabel() {
    ModuleInfo moduleInfo = Modules.getDefault().ownerOf(EomtbxAboutBoxProvider.class);
    return new JLabel(String.format("<html><b>EOMasters Toolbox version %s</b>",
